...
@section('content')
    ...
    <link rel="stylesheet" href="{{ asset('admin/css/edit-page.css') }}"/>
        ...
        <div class="card container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6">
                    ...
                    <form action="{{ route('admin.empresa.data-store') }}" method="post">
                        @csrf
                        ...
                        <div class="buttons-division mb-5">
                            ...
                            <a href="{{ route('admin.companys') }}" class="btn btn-link btn-lg btn-block mb-2"><</a>
